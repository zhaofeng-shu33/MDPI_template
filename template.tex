...
exact recovery of label $X$ is possible by \eqref{eq:abk}. Besides, some recovery algorithm like maximum likelihood or our proposed Metropolis sampling requires good estimation of $a,b$
...
This algorithm requires the number of the communities $k$ is known and the parameter $\gamma$ is given. We can choose $\gamma > b$ where $b$ is estimated
by the estimator mentioned Theorem \ref{thm:ab12}.
