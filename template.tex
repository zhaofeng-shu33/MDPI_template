...
\end{Definition}
In physics, $\beta$ is referred to the inverse temperature and $Z_G(\gamma, \beta)$ as the partition function.
The Hamiltonian energy $H(\bar{\sigma})$ consists of two terms: the repelling interaction between nodes without edge connection
and the attracting interaction between nodes with edge connection. The parameter $\gamma$ is the ratio of the power of these two
