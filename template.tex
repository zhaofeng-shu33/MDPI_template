...
could also be done within all balanced partition. We will show that the constrained search is equivalent with graph minimum cut problem and we will give the detection
...
The vertical red line $\beta=\beta^* = 0.198$, computed from \eqref{eq:beta_star}, represents the phase transition threshold. The point $(0.199,0.5)$ in the figure
